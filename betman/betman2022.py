...
text_list = []
pathcsv = './betmandata/betman2022.csv'  # csv��일 경로
try:
    driver.get(
        'https://www.betman.co.kr/main/mainPage/gamebuy/gameSlipIFR.do?gmId=G101&gmTs=220001&gameDivCd=C&isIFR=Y')
    # 전체리스트
...
# tr 태그의 개수를 세어 출력합니다.
    ...
    for i in range(len(tr_elements)):
        ...
        n_table = pd.DataFrame(result, columns=(
            '2022' 'db_fs11', 'badge_gray', 'scoreDiv_fwb', 'formBox', 'fs11'))
